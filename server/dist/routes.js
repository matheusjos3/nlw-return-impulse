...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const nodemailterMailAdapter = new nodemailer_mail_adapter_1.NodeMailerMailAdapter();
    const submitFeedbackUseCase = new submit_feedback_use_case_1.SubmitFeedbackUseCase(prismaFeedbackRepository, nodemailterMailAdapter);
